                ...
                <section className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center pt-20">
                    <div className="space-y-3 md:space-y-5 lg:space-y-6 animate-fade-up">
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 md:gap-6 lg:gap-8 mt-2 relative z-20">
                            <Link href="#shop" className="group relative overflow-hidden bg-white text-black px-8 py-3.5 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-500 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
                                <span className="relative z-10 flex items-center gap-2">
                                    Découvrir la Boutique
                                    <ArrowRight size={12} strokeWidth={1} className="group-hover:translate-x-1 transition-transform duration-500" />
                                </span>
                            </Link>
                            <Link href="#about" className="text-white/40 hover:text-white transition-all text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] group relative py-2">
                                Notre Histoire
