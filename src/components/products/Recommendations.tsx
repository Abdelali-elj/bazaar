            ...
            <div className="max-w-[90rem] mx-auto px-6 lg:px-12">
                ...
                <div className="flex gap-6 overflow-x-auto pb-8 luxury-scrollbar snap-x snap-mandatory h-auto">
                    {products.map((product, idx) => (
                        ...
                        >
                            <Link href={`/fastshop/${product.id}?qty=1`} className="block relative aspect-[4/5] rounded-[2rem] overflow-hidden mb-6 bg-slate-50">
                                <img 
                            ...
                            <div className="px-2 pb-2">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href={`/fastshop/${product.id}?qty=1`} className="text-[9px] font-black text-slate-300 uppercase tracking-widest hover:text-[#1A2E28] transition-colors flex items-center gap-2">
                                        Commander
                                        <ArrowRight size={12} />
                                    </Link>
                                </div>
