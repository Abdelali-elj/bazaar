                ...
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="space-y-10 lg:pl-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 pt-6">
                            <Link href="/products" className="w-full sm:w-auto px-10 py-5 bg-[#C9A96E] text-white rounded-full text-[11px] font-black uppercase tracking-[0.3em] overflow-hidden group relative shadow-[0_20px_40px_rgba(201,169,110,0.3)] hover:shadow-[#C9A96E]/40 transition-all active:scale-95 inline-flex items-center justify-center">
