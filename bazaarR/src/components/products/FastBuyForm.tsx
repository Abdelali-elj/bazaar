        ...
        return (
            <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-md bg-white rounded-[2rem] p-10 text-center animate-in zoom-in-95 duration-500 shadow-2xl">
                    <button onClick={() => isFullScreen ? router('/') : handleBack()} className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-full bg-slate-50 hover:bg-slate-100 text-slate-400 transition-all hover:rotate-90">
                        <X size={20} />
                    </button>
                    ...
                    <button onClick={() => isFullScreen ? router('/') : handleBack()} className="w-full py-4 bg-[#1A2E28] text-white text-[11px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-[#C9A96E] transition-colors">
