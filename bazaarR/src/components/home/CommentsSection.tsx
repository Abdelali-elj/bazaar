                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex gap-0.5">
                                                    {[...Array(5)].map((_, i) => (
                                                        <Star key={i} size={12} ={i < comment.rating ? "#FFC107" : "transparent"} color={i < comment.rating ? "#FFC107" : "#E2E8F0"} strokeWidth={1} />
                                                    ))}
                                                </div>
                            ...
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex-1 px-8">
                                    <div className="flex gap-0.5 justify-center mb-1">
                                        {[1, 2, 3, 4, 5].map(i => (
                                            <Star key={i} size={14} ={i <= parseFloat(ratingStats.avg) ? "#C9A96E" : "#E5E7EB"} color={i <= parseFloat(ratingStats.avg) ? "#C9A96E" : "#E5E7EB"} />
                                        ))}
                                    </div>
                                ...
                                <div className="flex gap-2 justify-center py-2">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <Star
                                            ...
                                            ={(hoverRating || rating) >= star ? "#C9A96E" : "transparent"}
